...
public class CardBrowser extends Activity {
    ...
    String filterQuery = "";
    String queryStart;
    String queryEnd = " ORDER BY Affinity ASC, Cost ASC, CardName ASC";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        queryStart = "SELECT _id,CardName,Type,Cost,Affinity,StatTypeOne,StatValueOne,StatTypeTwo,StatValueTwo,StatTypeThree,StatValueThree,StatTypeFour,StatValueFour FROM Cards WHERE Type IN ('Passive','Active','Upgrade')";
